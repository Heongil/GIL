...
function _Unity_InitAsync(initmode, useAdapter) {
...
function _Unity_MediaNetwork_GetConfigurationError(lIndex, lBufferPtr, lBufferLen) {
...
function _Unity_MediaNetwork_GetConfigurationError_Length(lIndex) {
...
function _Unity_Media_EnableScreenCapture(name) {
...
function _cleanup() {
 if (document.fbStorage == null || document.fbStorage.initialized !== true) return;
...
function _loadFileData(fileName) {
 if (document.fbStorage == null || document.fbStorage.initialized !== true) return null;
...
function _openFileBrowserForLoad(typesFilter, isMultipleSelection) {
...
var asmLibraryArg = {
 ...
 "Unity_MediaNetwork_GetConfigurationError_Length": _Unity_MediaNetwork_GetConfigurationError_Length,
 ...
 "Unity_Media_EnableScreenCapture": _Unity_Media_EnableScreenCapture,
